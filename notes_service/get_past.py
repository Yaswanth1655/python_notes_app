...
def handle_get_past(event: dict, user_id: str) -> dict:
    """
    Handle get past notes request.
    ...
    try:
        ...
        # Get start of today (notes before this are "past")
        ...
        # Query notes before today (descending order - newest first)
        result = db.query_notes_before_date(
            user_id=user_id,
            before_date=start_of_day,
            limit=limit,
        ...
        print(f"Error getting past notes: {e}")
