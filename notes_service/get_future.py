...
def handle_get_future(event: dict, user_id: str) -> dict:
    """
    Handle get future notes request.
    ...
    try:
        ...
        # Get end of today (notes after this are "future")
        ...
        # Query notes after today (ascending order - oldest first)
        result = db.query_notes_after_date(
            user_id=user_id,
            after_date=end_of_day,
            limit=limit,
        ...
        print(f"Error getting future notes: {e}")
